...
class LineOutDoolyEditorPage extends StatefulWidget {
  LineOutDoolyEditorPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LineOutDoolyEditorPageState createState() => _LineOutDoolyEditorPageState();
}

class _LineOutDoolyEditorPageState extends State<LineOutDoolyEditorPage> {
