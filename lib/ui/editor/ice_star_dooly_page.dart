...
class IceStarDoolyEditorPage extends StatefulWidget {
  IceStarDoolyEditorPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _IceStarDoolyEditorPageState createState() => _IceStarDoolyEditorPageState();
}

class _IceStarDoolyEditorPageState extends State<IceStarDoolyEditorPage> {
