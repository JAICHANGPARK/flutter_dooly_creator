...
class BecareWellDoolyEditorPage extends StatefulWidget {
  BecareWellDoolyEditorPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _BecareWellDoolyEditorPageState createState() => _BecareWellDoolyEditorPageState();
}

class _BecareWellDoolyEditorPageState extends State<BecareWellDoolyEditorPage> {
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: Column(
                                ...
                                children: [
                                  ...
                                  MaterialButton(
                                    onPressed: () async {
                                      bool result = await saveFile(imgData,"becareful_dooly");
                                  ...
                                  OutlinedButton(
                                    onPressed: () async {
                                      shareImageFile(imgData, "becareful_dooly");
                                    },
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
