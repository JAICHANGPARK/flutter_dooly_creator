...
class GilDongWantGoHomeEditorPage extends StatefulWidget {
  GilDongWantGoHomeEditorPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _GilDongWantGoHomePageState createState() => _GilDongWantGoHomePageState();
}

class _GilDongWantGoHomePageState extends State<GilDongWantGoHomeEditorPage> {
                            ...
                            child: Container(
                              child: Center(
                                child: Text(
                                  _firstText,
                                  style:
                                      TextStyle(fontSize: _fontSize, color: Colors.black, fontWeight: FontWeight.bold),
                                ),
                              ),
                            ),
                          ),
