...
class GilDongCoughEditorPage extends StatefulWidget {
  GilDongCoughEditorPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _GilDongCoughPageState createState() => _GilDongCoughPageState();
}

class _GilDongCoughPageState extends State<GilDongCoughEditorPage> {
